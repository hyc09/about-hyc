    ...
    return (
      ...
      >
        ...
        >
          ...
          <p>Medium 紀錄我的生活隨筆、閱聽心得，以及部分《TAIPEI》的人物專訪。受訪人物皆為在台工作多年的各領域日籍人士，刊物本身以英文與日文發行，故將中文原文發表於此。</p>
          <p>比起傳奇傳記，我更著迷市井生活，他可能是廚師、作家、演員、導演、記者或家庭主婦，在初次見面的一個小時裡，盡情傾聽陌生人的故事，除了心理諮商與算命，沒有比專訪更正當的理由了。</p>
...
{/* ////////// 桃園茶行 - 品牌故事 ////////// */}
          ...
          <h3>桃園茶行 / 騰峰香茗 / 茶米兒</h3>
          <p>來自桃園大溪的百年茶行，擁有拉拉山上的一片茶園與一群手工製茶的老師傅。歷經六代傳承，年輕品牌茶米兒的誕生來自老闆的兒時回憶，結合茶品與茶餐點，將正宗古法台灣茶與更多人分享，賦予茶葉新時代的面貌。</p>
          <span className="image main">
...
{/* ////////// 台灣工藝發展中心 - 企劃 ////////// */}
          ...
          <blockquote>
            <h4>當代匠心・經典新裁</h4>
            <p>
            服飾如同語言，作為一種表達自我的方式，極其熨貼自身，也同時深受歷史、地理、文化和民族的影響。本書在宏觀的時間軸上，以各世代不同的設計師為座標，紀錄了當代客、閩女性服飾的重要特色；同時，從材料、技法、圖案、色彩等微觀的角度，探索織品手藝裡蘊含的人文思維。
            </p>
            <p>
            1970 年迄今的 50 年，正是當代服裝發展史的重要跨度。在 1960 至 1970 年間， 隨著台灣經濟起飛、電視媒體與百貨業成立，使得西方流行元素大量注流， 除了傳統師承制度的洋裁店，重要的教育機構如實踐大學（原實踐家政專科學校）、台南應用科技大學（原台南家政專科學校）與輔仁大學先後成立了織品設計科系，時裝設計走入專業教育，開始在本土大鳴異彩。1970 年代，我們有以華麗、繁複東方圖騰完美融合西方美學的王陳彩霞；以釘珠、刺繡結合傳統戲曲征戰國際的潘黛麗；用手工織染的香雲紗編織一場又一場如夢大秀的洪麗芬。1980 年代，以立體剪裁展演多元社會議題的葉伽伶；揉合藝術與時尚、前衛與復古，打造「溫氏美學」的溫慶珠，以及擅用極簡主義凸顯女性柔美線條的陳季敏。
            </p>
            <p>
            1990 年代，完美平衡對比媒材，打造衝突美學的竇騰璜；追求自然原貌，以藍染、絲雕、繡花和針扎複合不同素材的徐秋宜。2000 年代，以細膩、獨到的針織手法創造獨樹一格針織時尚的潘怡良；以雕塑一般的羊毛條立體編織奪下國際服裝競賽 Gen Art 前衛時裝大獎的古又文；圍繞花卉主題，以克什米爾、羊毛和絲進軍倫敦時裝界的首位台灣設計師 —— 郭曉璇。2010 年後，以針織、原創布料、印花結合奇幻風格的詹朴；顛覆傳統與現代、擅長將中西文化符號解構再重組的周裕穎⋯⋯。
            </p>
            <p>
            服裝是設計師用以敘述世代的語言，工藝中的敲打、編織、紡染、繪繡則是串起時代和文化的動作記憶。臺灣土地兼容不同族群，深受華夏、歐美及日本影響，擁有多元、豐富的文化底蘊，卻也逐步走出屬於自己的地在時尚。在地與國際，傳統與創新，不斷更新的當代女性服裝工藝史正代表著臺灣設計師不懈的追求，以服飾向世界展演：臺灣製，來自臺灣，向世界發光。
            </p>
          </blockquote>
...
{/* ////////// --- ABOUT --- ////////// */}
          ...
          <p>
            ...
            畢業於臨床心理系，有兩隻貓。<br />
            喜歡的編劇與作家：是枝裕和、坂元裕二、吳明益、畢飛宇、閻連科、黃麗群<br />
            漫畫家：松本大洋、浦澤直樹、富堅義博<br />
            疫情消失後想做的事是爬郊山、游泳以及坐在路邊吃小吃。<br />
            最近正在學習寫程式，但學得很慢。
        ...
        >
          <h2 className="major">Contact</h2>
            ...
            <h4>技術類文件</h4>
            <p>網站說明文件、後台教學文件等，專業用語不會成為我們之間的阻礙。</p>
